 ...
 */
@PWA(name = "Study Helper ", shortName = "Study Helper ", enableInstallPrompt = false)
@Theme(themeFolder = "studyhelper", variant = Lumo.DARK)
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Study Helper  logo"));
        logoLayout.add(new H1("Study Helper "));
